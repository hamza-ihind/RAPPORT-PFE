...
La phase \textit{Définir} constitue la première étape de la méthodologie DMAIC. Elle vise à poser les fondations du projet en clarifiant le contexte, les objectifs, les acteurs impliqués et les contraintes à prendre en compte. Cette étape est essentielle car elle permet de s'assurer que toutes les parties prenantes partagent la même compréhension du problème à résoudre et des résultats attendus.

Dans le cadre de notre projet chez Segula Technologies Maroc, il s'agit d'automatiser le contrôle qualité des pièces CATIA à travers le développement de macros VBA jouant le rôle de Q-Checker métier. Ce chapitre présente la charte de projet, justifie le choix de la démarche DMAIC par rapport à d'autres méthodes de résolution de problèmes, et détaille les outils logiciels mobilisés pour mener à bien ce travail.
