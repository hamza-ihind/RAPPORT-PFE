...
\include{Chapters/03-Generalites-Automobile}
\include{Chapters/04-Definir}
\include{Chapters/05-Mesurer}
\include{Chapters/06-Analyser}
\include{Chapters/07-Innover}
\include{Chapters/08-Controler}
% \include{Chapters/01-Examples}
